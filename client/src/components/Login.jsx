...
import loginimage from '../assets/undraw_Sign_in_re_o58h.png';
const Login = () => {
     // hoock form 
     const {
        register,
...
<div className="flex lg:flex-row md:flex-row flex-col mx-auto justify-center items-center  mt-4 gap-8">
    ...
    <div className="container flex items-center justify-start min-h-screen px-6 mx-auto">
        ...
        <strong to={'/'} className=" font-bold lg:text-2xl text-xl text-wrap"><span className="text-[#3B82F6]">ALTPRODINFO</span> .COM</strong>
        <hr />
            ...
            <div className="mt-6">
                ...
                <div className="mt-6 text-center ">
                    <a href="#" className="text-sm text-blue-500 hover:underline dark:text-blue-400">
                        Don’t have an account yet?<Link to={'/registation'} > Sign up</Link>
                    </a>
                </div>
            </div>
        </form>
