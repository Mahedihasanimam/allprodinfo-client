  ...
  return (
    <div>
      ...
      <div className="overflow-x-auto min-h-screen my-8 px-4">
        ...
        {
          myrecomentData.length<1 && <div className="flex mx-auto my-8 flex-row px-4 lg:w-[1000PX]  pl-4 py-2 gap-2 items-center border rounded-lg shadow overflow-hidden bg-gray-900 dark:bg-gray-50 border-violet-400 dark:border-violet-600">
